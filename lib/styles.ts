...
export const uiGapText = ui("gap-x-3 gap-y-2");
export const uiGapItems = ui("gap-2");
export const uiRounded = ui("rounded-lg");
export const uiPanel = ui(uiRounded, uiP, uiBg);
export const uiBigPanel = ui(uiRounded, "px-6 py-5", uiBg);
export const uiText = ui("min-h-[1lh] text-2xl font-normal select-none cursor-default", uiTextColor);
export const uiTextWeak = ui(uiText, "select-none cursor-default", uiTextColorWeak);
export const uiTextTiny = ui(uiTextWeak, "text-xl");
